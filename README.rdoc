...
Additionally, you can connect to your sandbox environment using:

  salesforce = SalesforceBulk::Api.new("YOUR_SALESFORCE_DEV_USERNAME", "YOUR_SALESFORCE_DEV_PASSWORD+YOUR_SALESFORCE_DEV_TOKEN", true)
