...
If you initialize by passing only the name of a YAML file when you create a `SalesforceBulk::Client` object, the new Client object will read the YAML file and take all values from there.
